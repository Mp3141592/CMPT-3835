...
# Load chatbot chunks CSV (final correct one)
df_chunks = pd.read_csv("chatbot_chunks_combined_improved (version 1).csv")

# Use correct column names from your CSV: "chunk"
documents = dict(zip(df_chunks["chunk"], df_chunks["chunk"]))

# Set up embedding and text generation models
